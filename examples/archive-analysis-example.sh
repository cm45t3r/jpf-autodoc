...
echo "   ./bin/jpfautodoc -cp jpf-core.jar --config-only -o markdown -f jpf-config.md"
echo

echo "2. Analyzing from ZIP archive (jpf-core.zip)"
echo "   ./bin/jpfautodoc -cp jpf-core.zip --types-only -o xml -f jpf-types.xml"
echo

echo "3. Analyzing from directory containing archives"
echo "   ./bin/jpfautodoc -cp /path/to/libs/ --verbose -o html -f analysis.html"
echo
...
echo "  ./bin/jpfautodoc -cp jpf-core.jar --config-only -o markdown -f config.md"
echo
echo "  # If you have jpf-core.zip:"
echo "  ./bin/jpfautodoc -cp jpf-core.zip --types-only -o xml -f types.xml"
echo
echo "  # If you have a directory with multiple archives:"
echo "  ./bin/jpfautodoc -cp ./libs/ --verbose -o html -f analysis.html"
echo
